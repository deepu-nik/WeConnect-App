...
const styles=StyleSheet.create({
 ...
 tabContent:{paddingHorizontal:16,paddingTop:14},emptyTab:{minHeight:180,borderRadius:20,backgroundColor:'#fff',borderWidth:1,borderColor:'#E5E5DF',alignItems:'center',justifyContent:'center',padding:25},emptyTabIcon:{width:52,height:52,borderRadius:18,backgroundColor:'#FFFC00',alignItems:'center',justifyContent:'center'},emptyTabTitle:{fontSize:16,fontWeight:'900',color:'#111',marginTop:12},emptyTabText:{fontSize:12,lineHeight:18,color:'#777770',textAlign:'center',marginTop:5},footerSpace:{height:15},privacyShortcut:{marginHorizontal:16,marginBottom:2,padding:15,borderRadius:19,backgroundColor:'#fff',borderWidth:1,borderColor:'#E5E5DF',flexDirection:'row',alignItems:'center'},privacyShortcutCopy:{flex:1,paddingRight:10},privacyShortcutTitle:{fontSize:14,fontWeight:'900',color:'#222'},privacyShortcutText:{fontSize:10.5,lineHeight:16,color:'#777770',marginTop:4},privacyShortcutButton:{minHeight:38,paddingHorizontal:12,borderRadius:19,backgroundColor:'#FFFC00',flexDirection:'row',alignItems:'center',gap:6},privacyShortcutButtonText:{fontSize:11,fontWeight:'900',color:'#111'},
